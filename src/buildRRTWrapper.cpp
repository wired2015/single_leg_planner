                     ...
                     *success)
{
  ...
  if (validJointState(nInitJoint, jointLimits) && validJointState(nGoalJoint,
    ...
    *success = true;
    ...
    nGoal[1] = 0.0;
    nGoal[2] = 0.0;
    memcpy(&nGoal[3], &nGoalJoint[0], 10U * sizeof(double));
    ...
    nearestNeighbour(nGoal, b_T, kC->l1, kC->l2, kC->l3, kC->l4, kC->l5, kC->l6,
...
{
  int i8;
  static const double dv11[4] = { -0.293, -1.1326, -0.671, -0.7546 };

  static const double dv12[3] = { 1.0, 0.0, 0.5 };

  for (i8 = 0; i8 < 4; i8++) {
    cartesianLimits[i8] = dv11[i8];
  }
