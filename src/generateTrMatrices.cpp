  ...
  TR2Q[16], double TS2R[16], double TW2S[16], double TC2W[16])
{
  ...
  static const double dv5[4] = { 0.0, -1.0, 6.123233995736766E-17, 0.0 };

  static const signed char iv4[4] = { 1, 0, 0, 0 };

  static const signed char iv5[4] = { 0, 1, 0, 0 };

  static const double dv6[4] = { 6.123233995736766E-17, -6.123233995736766E-17,
    1.0, 0.0 };

  static const double dv7[4] = { 1.0, 3.749399456654644E-33,
    -6.123233995736766E-17, 0.0 };

  double dv8[16];
  static const double dv9[4] = { 6.123233995736766E-17, -1.0, 0.0, 0.0 };

  static const double dv10[4] = { 1.0, 6.123233995736766E-17, -0.0, 0.0 };
  ...
  for (i6 = 0; i6 < 4; i6++) {
    for (k = 0; k < 4; k++) {
      TC2W[i6 + (k << 2)] = 0.0;
      for (i7 = 0; i7 < 4; i7++) {
        TC2W[i6 + (k << 2)] += a[i6 + (i7 << 2)] * dv8[i7 + (k << 2)];
      }
    }
  }
}
