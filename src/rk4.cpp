  ...
  for (i = 0; i < (int)numIterations; i++) {
    ...
    for (i4 = 0; i4 < 3; i4++) {
      for (i5 = 0; i5 < 3; i5++) {
        ...
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv1[i4 + 3 * i5] += dv0[i4 + 3 * xInit_size_idx_1] *
    ...
    for (i4 = 0; i4 < 3; i4++) {
      for (i5 = 0; i5 < 3; i5++) {
        ...
        dv1[i4 + 3 * i5] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv1[i4 + 3 * i5] += dv2[i4 + 3 * xInit_size_idx_1] *
    ...
    for (i4 = 0; i4 < 3; i4++) {
      for (i5 = 0; i5 < 3; i5++) {
        ...
        dv1[i4 + 3 * i5] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv1[i4 + 3 * i5] += dv3[i4 + 3 * xInit_size_idx_1] *
    ...
    for (i4 = 0; i4 < 3; i4++) {
      for (i5 = 0; i5 < 3; i5++) {
        ...
        dv1[i4 + 3 * i5] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv1[i4 + 3 * i5] += dv4[i4 + 3 * xInit_size_idx_1] *
