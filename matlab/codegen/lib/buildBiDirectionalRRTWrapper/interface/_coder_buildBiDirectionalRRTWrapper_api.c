/*
 * File: _coder_buildBiDirectionalRRTWrapper_api.c
 *
...
void buildBiDirectionalRRTWrapper_atexit(void)
{
  ...
  emlrtLeaveRtStackR2012b(&st);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  buildBiDirectionalRRTWrapper_xil_terminate();
}
 ...
 * Return Type  : void
 */
void buildBiDirectionalRRTWrapper_api(const mxArray *prhs[13], const mxArray
  *plhs[5])
{
  emxArray_real_T *T1;
  emxArray_real_T *T2;
  ...
  threshold = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[10]), "threshold");
...
/*
 * File trailer for _coder_buildBiDirectionalRRTWrapper_api.c
 *
 * [EOF]
 */
