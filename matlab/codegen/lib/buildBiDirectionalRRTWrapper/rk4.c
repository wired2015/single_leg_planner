         ...
         *transitionArray)
{
  ...
  emxEnsureCapacity((emxArray__common *)transitionArray, i6, (int)sizeof(double));
  ...
  for (i6 = 0; i6 < 10; i6++) {
    transitionArray->data[i6] = xInit_data[i6];
  }
  ...
  for (i = 0; i < (int)numIterations; i++) {
    ...
    for (i6 = 0; i6 < 10; i6++) {
      c_xInit_data[i6] = xInit_data[i6] + y * k3[i6];
      d_xInit_data[i6] = xInit_data[i6] + alphaDotDot * (((k1[i6] + 2.0 * k2[i6])
    ...
    xNew_size[1] = 10;
    for (i6 = 0; i6 < 10; i6++) {
      xNew_data[i6] = xInit_data[i6] + alphaDotDot * (((k1[i6] + 2.0 * k2[i6]) +
        2.0 * k3[i6]) + e_xInit_data[i6]);
    }
    ...
    for (i6 = 0; i6 < 4; i6++) {
      for (i7 = 0; i7 < 4; i7++) {
        ...
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          TO2S[i6 + (i7 << 2)] += TI2S[i6 + (xInit_size_idx_1 << 2)] *
            TI2P[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        TP2S[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          TP2S[i6 + (i7 << 2)] += TO2S[i6 + (xInit_size_idx_1 << 2)] *
            TJ2I[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        TB2S[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          TB2S[i6 + (i7 << 2)] += TP2S[i6 + (xInit_size_idx_1 << 2)] *
            TO2J[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        c_TI2S[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          c_TI2S[i6 + (i7 << 2)] += TB2S[i6 + (xInit_size_idx_1 << 2)] *
            TQ2O[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        d_TI2S[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          d_TI2S[i6 + (i7 << 2)] += c_TI2S[i6 + (xInit_size_idx_1 << 2)] *
            TR2Q[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        b_TI2S[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          b_TI2S[i6 + (i7 << 2)] += d_TI2S[i6 + (xInit_size_idx_1 << 2)] *
            TS2R[xInit_size_idx_1 + (i7 << 2)];
        }

        b_TI2P[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          b_TI2P[i6 + (i7 << 2)] += TI2P[i6 + (xInit_size_idx_1 << 2)] *
            TJ2I[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        c_TI2P[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          c_TI2P[i6 + (i7 << 2)] += b_TI2P[i6 + (xInit_size_idx_1 << 2)] *
            TO2J[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        d_TI2P[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          d_TI2P[i6 + (i7 << 2)] += c_TI2P[i6 + (xInit_size_idx_1 << 2)] *
            TQ2O[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        e_TI2P[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          e_TI2P[i6 + (i7 << 2)] += d_TI2P[i6 + (xInit_size_idx_1 << 2)] *
            TR2Q[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        f_TI2P[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          f_TI2P[i6 + (i7 << 2)] += e_TI2P[i6 + (xInit_size_idx_1 << 2)] *
            TS2R[xInit_size_idx_1 + (i7 << 2)];
        }

        b_TJ2I[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          b_TJ2I[i6 + (i7 << 2)] += TJ2I[i6 + (xInit_size_idx_1 << 2)] *
            TO2J[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        c_TJ2I[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          c_TJ2I[i6 + (i7 << 2)] += b_TJ2I[i6 + (xInit_size_idx_1 << 2)] *
            TQ2O[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        d_TJ2I[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          d_TJ2I[i6 + (i7 << 2)] += c_TJ2I[i6 + (xInit_size_idx_1 << 2)] *
            TR2Q[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        e_TJ2I[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          e_TJ2I[i6 + (i7 << 2)] += d_TJ2I[i6 + (xInit_size_idx_1 << 2)] *
            TS2R[xInit_size_idx_1 + (i7 << 2)];
        }

        b_TQ2O[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          b_TQ2O[i6 + (i7 << 2)] += TQ2O[i6 + (xInit_size_idx_1 << 2)] *
            TR2Q[xInit_size_idx_1 + (i7 << 2)];
        }
      }
      ...
      for (i7 = 0; i7 < 4; i7++) {
        c_TQ2O[i6 + (i7 << 2)] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 4; xInit_size_idx_1++) {
          c_TQ2O[i6 + (i7 << 2)] += b_TQ2O[i6 + (xInit_size_idx_1 << 2)] *
            TS2R[xInit_size_idx_1 + (i7 << 2)];
        }
      }
    }
    ...
    for (i6 = 0; i6 < 3; i6++) {
      for (i7 = 0; i7 < 3; i7++) {
        ...
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv3[i6 + 3 * i7] += dv2[i6 + 3 * xInit_size_idx_1] *
            TB2S[xInit_size_idx_1 + (i7 << 2)];
        }
    ...
    for (i6 = 0; i6 < 3; i6++) {
      ...
      for (i7 = 0; i7 < 3; i7++) {
        ...
        dv3[i6 + 3 * i7] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv3[i6 + 3 * i7] += dv4[i6 + 3 * xInit_size_idx_1] *
            TP2S[xInit_size_idx_1 + (i7 << 2)];
        }
    ...
    for (i6 = 0; i6 < 6; i6++) {
      ...
      c_TP2S[i6] = 0.0;
      for (i7 = 0; i7 < 6; i7++) {
        c_TP2S[i6] += b_TP2S[i6 + 6 * i7] * b_TO2S[i7];
      }
    }
    ...
    for (i6 = 0; i6 < 3; i6++) {
      ...
      for (i7 = 0; i7 < 3; i7++) {
        dv3[i6 + 3 * i7] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv3[i6 + 3 * i7] += dv5[i6 + 3 * xInit_size_idx_1] *
            TI2S[xInit_size_idx_1 + (i7 << 2)];
        }

        e_TI2S[i7 + 6 * i6] = TI2S[i7 + (i6 << 2)];
      }
    }
    ...
    for (i6 = 0; i6 < 3; i6++) {
      for (i7 = 0; i7 < 3; i7++) {
        e_TI2S[i7 + 6 * (i6 + 3)] = dv3[i7 + 3 * i6];
      }
    }

    for (i6 = 0; i6 < 3; i6++) {
      for (i7 = 0; i7 < 3; i7++) {
        e_TI2S[(i7 + 6 * i6) + 3] = 0.0;
      }
    }
    ...
    for (i6 = 0; i6 < 3; i6++) {
      dv7[i6] = 0.0;
      for (i7 = 0; i7 < 3; i7++) {
        e_TI2S[(i7 + 6 * (i6 + 3)) + 3] = TI2S[i7 + (i6 << 2)];
        dv3[i6 + 3 * i7] = 0.0;
        for (xInit_size_idx_1 = 0; xInit_size_idx_1 < 3; xInit_size_idx_1++) {
          dv3[i6 + 3 * i7] += dv6[i6 + 3 * xInit_size_idx_1] *
            TO2S[xInit_size_idx_1 + (i7 << 2)];
        }

        c_TO2S[i7 + 6 * i6] = TO2S[i7 + (i6 << 2)];
      }
    }
    ...
    for (i6 = 0; i6 < 3; i6++) {
      for (i7 = 0; i7 < 3; i7++) {
        c_TO2S[i7 + 6 * (i6 + 3)] = dv3[i7 + 3 * i6];
      }
    }

    for (i6 = 0; i6 < 3; i6++) {
      for (i7 = 0; i7 < 3; i7++) {
        c_TO2S[(i7 + 6 * i6) + 3] = 0.0;
      }
    }

    for (i6 = 0; i6 < 3; i6++) {
      for (i7 = 0; i7 < 3; i7++) {
        c_TO2S[(i7 + 6 * (i6 + 3)) + 3] = TO2S[i7 + (i6 << 2)];
      }
    }
    ...
    for (i6 = 0; i6 < 6; i6++) {
      b_TO2S[i6] = 0.0;
      for (i7 = 0; i7 < 6; i7++) {
        b_TO2S[i6] += c_TO2S[i6 + 6 * i7] * dv7[i7];
      }

      uSDot[i6] = c_TB2S[i6] + b_TO2S[i6];
    }
    ...
    xNew_size[1] = 10;
    for (i6 = 0; i6 < 10; i6++) {
      xNew_data[xNew_size[0] * i6] = c_alpha[i6];
    }
    ...
    for (i7 = 0; i7 < loop_ub; i7++) {
      transitionArray->data[i6 + i7] = xNew_data[xNew_size[0] * i7];
    }
  }
  ...
  loop_ub = xNew_size[1];
  for (i6 = 0; i6 < loop_ub; i6++) {
    TO2S[i6 + 3] = xNew_data[xNew_size[0] * i6];
  }

  xNew_size[0] = 1;
  xNew_size[1] = xInit_size_idx_1;
  for (i6 = 0; i6 < xInit_size_idx_1; i6++) {
    xNew_data[xNew_size[0] * i6] = TO2S[i6];
  }
}

/*
 * File trailer for rk4.c
 *
 * [EOF]
 */
