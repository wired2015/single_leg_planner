...
// Return Type  : void
//
void sherpaTTIK(double xC, double yC, double zC, const double kinematicConst[16],
                ...
                double *b_gamma)
{
  ...
  extractKinematicConstants(kinematicConst, &L1, &L2, &L3, &L4, &L5, &L6, &L7,
    ...
    &unusedU6);
  x = sqrt(xC * xC + yC * yC);
  a = ((((((((((((((((((((((((L1 * L1 - 2.0 * sin(zeta) * L1 * L4) - 2.0 * L1 *
    L6) - 2.0 * L1 * L8) - 2.0 * L1 * zC) + L2 * L2) + 2.0 * cos(zeta) * L2 * L4)
                        - 2.0 * L2 * L7) - 2.0 * L2 * x) - L3 * L3) + L4 * L4) +
                    2.0 * sin(zeta) * L4 * L6) - 2.0 * cos(zeta) * L4 * L7) +
                  2.0 * sin(zeta) * L4 * L8) - 2.0 * cos(zeta) * L4 * x) + 2.0 *
                sin(zeta) * L4 * zC) + L5 * L5) + L6 * L6) + 2.0 * L6 * L8) +
            2.0 * L6 * zC) + L7 * L7) + 2.0 * L7 * x) + L8 * L8) + 2.0 * L8 * zC)
       + x * x) + zC * zC;
  b_x = cos(zeta);
  c_x = sin(zeta);
  b_a = ((((((((((((((((((((((((L1 * L1 - 2.0 * sin(zeta) * L1 * L4) - 2.0 * L1 *
    L6) - 2.0 * L1 * L8) - 2.0 * L1 * zC) + L2 * L2) + 2.0 * cos(zeta) * L2 * L4)
    - 2.0 * L2 * L7) - 2.0 * L2 * x) - L3 * L3) + L4 * L4) + 2.0 * sin(zeta) *
                      L4 * L6) - 2.0 * cos(zeta) * L4 * L7) + 2.0 * sin(zeta) *
                    L4 * L8) - 2.0 * cos(zeta) * L4 * x) + 2.0 * sin(zeta) * L4 *
                  zC) + L5 * L5) + L6 * L6) + 2.0 * L6 * L8) + 2.0 * L6 * zC) +
             L7 * L7) + 2.0 * L7 * x) + L8 * L8) + 2.0 * L8 * zC) + x * x) + zC *
    zC;
  d_x = cos(zeta);
  e_x = sin(zeta);
  dc0.re = zeta * 0.0;
  ...
  ar = -((((((((((((((((((((((((((((r * 0.0 - L1_im) + (L2_re * 0.0 - L2_im)) -
    ...
    0.0 - b_L2_im)) + (b_L6_re * 0.0 - b_L6_im)) - L1 * L4 * (cos(2.0 * zeta) -
    1.0)) + L4 * L6 * (cos(2.0 * zeta) - 1.0)) + L4 * L8 * (cos(2.0 * zeta) -
    1.0)) - (c_L2_re * 0.0 - c_L2_im)) + (b_L7_re * 0.0 - b_L7_im)) - (c_L1_re *
    0.0 - d_L1_im)) + (c_L6_re * 0.0 - c_L6_im)) + (b_L8_re * 0.0 - b_L8_im)) +
             L4 * zC * (cos(2.0 * zeta) - 1.0)) + (b_L4_re * 0.0 - b_L4_im)) +
  ...
  unusedU6 = -((((((((((((((((((((((((((((r + L1_im * 0.0) + (L2_re + L2_im *
    ...
    b_L2_im * 0.0)) + (b_L6_re + b_L6_im * 0.0)) - L1 * L4 * sin(2.0 * zeta)) +
    L4 * L6 * sin(2.0 * zeta)) + L4 * L8 * sin(2.0 * zeta)) - (c_L2_re + c_L2_im
    * 0.0)) + (b_L7_re + b_L7_im * 0.0)) - (c_L1_re + d_L1_im * 0.0)) + (c_L6_re
    + c_L6_im * 0.0)) + (b_L8_re + b_L8_im * 0.0)) + L4 * zC * sin(2.0 * zeta))
                  + (b_L4_re + b_L4_im * 0.0)) + (c_L4_re + c_L4_im * 0.0)) -
  ...
  if (unusedU3 == 0.0) {
    ...
    unusedU4 = fabs(unusedU5);
    unusedU1 = fabs(unusedU3);
  ...
  unusedU6 = -((((((((((((((((((((((((((((r + L1_im * 0.0) + (L2_re + L2_im *
    ...
    (b_L2_re + b_L2_im * 0.0)) + (b_L6_re + b_L6_im * 0.0)) - L1 * L4 * sin(2.0 *
    zeta)) + L4 * L6 * sin(2.0 * zeta)) + L4 * L8 * sin(2.0 * zeta)) - (c_L2_re
    + c_L2_im * 0.0)) + (b_L7_re + b_L7_im * 0.0)) - (c_L1_re + d_L1_im * 0.0))
                     + (c_L6_re + c_L6_im * 0.0)) + (b_L8_re + b_L8_im * 0.0)) +
                   L4 * zC * sin(2.0 * zeta)) + (b_L4_re + b_L4_im * 0.0)) +
                 (c_L4_re + c_L4_im * 0.0)) - (unusedU4 + unusedU3 * 0.0)) + L2 *
  ...
  b_sin(&dc0);
  L6_re = ((((L6 - L1) + L8) + zC) + L4 * sin(zeta)) - L5 * dc0.re;
  L6_im = 0.0 - L5 * dc0.im;
  if (L6_im == 0.0) {
    dc0.re = L6_re / L3;
    dc0.im = 0.0;
  ...
  b_asin(&dc0);
  ar = ((((L6 - L1) + L8) + zC) + L4 * sin(zeta)) - L5 * x_re;
