...
static real_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *K, const
  char_T *identifier);
...
static real_T (*i_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *kinematicConst, const char_T *identifier))[15];
...
void buildRRTWrapper_api(const mxArray *prhs[10], const mxArray *plhs[4])
{
  ...
  buildRRTWrapper(*nInitCartesianB, *nGoalCartesianB, *jointLimits, K, *U, dt,
                  Dt, *kinematicConst, threshold, legNum, T, pathC, pathJ,
                  &success);
