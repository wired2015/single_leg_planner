...
extern void buildRRTWrapper(real_T nInitCartesianB[6], real_T nGoalCartesianB[6], real_T jointLimits[12], real_T K, real_T U[10], real_T dt, real_T Dt, real_T kinematicConst[15], real_T threshold, int32_T legNum, emxArray_real_T *T, emxArray_real_T *pathC, emxArray_real_T *pathJ, boolean_T *success);
