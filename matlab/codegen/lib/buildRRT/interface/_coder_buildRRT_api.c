 ...
 * Return Type  : void
 */
void buildRRT_api(const mxArray *prhs[16], const mxArray *plhs[2])
{
  emxArray_real_T *T;
  ...
  buildRRT(*nInit, *nGoal, NUM_NODES, *jointLimits, K, *HGAINS, NODE_SIZE, *U,
           U_SIZE, dt, Dt, *kinematicConst, ankleThreshold, exhaustive,
...
/*
 * File trailer for _coder_buildRRT_api.c
 *
 * [EOF]
 */
