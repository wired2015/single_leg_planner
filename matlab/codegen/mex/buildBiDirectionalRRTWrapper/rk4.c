...
static emlrtRSInfo qb_emlrtRSI = { 6, "getPhiAndOmega",
...
static emlrtRTEInfo v_emlrtRTEI = { 18, 5, "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m"
};

static emlrtBCInfo y_emlrtBCI = { -1, -1, 139, 9, "transitionArray", "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m",
  0 };
...
static emlrtBCInfo ab_emlrtBCI = { -1, -1, 16, 5, "transitionArray", "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m",
  0 };
         ...
         xNew_size[2], emxArray_real_T *transitionArray)
{
  ...
  static const int8_T iv12[4] = { 0, 0, 1, 0 };

  static const real_T dv2[4] = { 0.0, -1.0, 6.123233995736766E-17, 0.0 };

  static const int8_T iv13[4] = { 1, 0, 0, 0 };

  real_T TS2R[16];
  static const int8_T iv14[4] = { 0, 1, 0, 0 };
  ...
  for (i6 = 0; i6 < 10; i6++) {
    transitionArray->data[emlrtDynamicBoundsCheckFastR2012b(i6 + 1, 1,
      unnamed_idx_1, &ab_emlrtBCI, sp) - 1] = xInit_data[i6];
  }

  emlrtForLoopVectorCheckR2012b(1.0, 1.0, numIterations, mxDOUBLE_CLASS,
    (int32_T)numIterations, &v_emlrtRTEI, sp);
  i = 0;
  while (i <= (int32_T)numIterations - 1) {
    ...
    emlrtDynamicBoundsCheckFastR2012b(legNum, 1, 4, &x_emlrtBCI, &b_st);
    ...
    if (y > b_y) {
      ...
      i7 = (int32_T)y;
      i6 = emlrtDynamicBoundsCheckFastR2012b(i7, 1, i6, &y_emlrtBCI, sp);
      i7 = transitionArray->size[1];
      unnamed_idx_1 = (int32_T)b_y;
      i7 = emlrtDynamicBoundsCheckFastR2012b(unnamed_idx_1, 1, i7, &y_emlrtBCI,
        sp) + 1;
    }

    i7 -= i6;
    emlrtSizeEqCheck1DFastR2012b(i7, 10, &g_emlrtECI, sp);
    loop_ub = xNew_size[1];
