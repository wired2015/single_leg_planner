...
MAKEFILE = randomStateGenerator_mex.mk

include randomStateGenerator_mex.mki


SRC_FILES =  \
	randomStateGenerator_data.c \
	...
	randomStateGenerator_emxutil.c \
	_coder_randomStateGenerator_mex.c \
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/randomStateGenerator"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/randomStateGenerator/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/randomStateGenerator/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/randomStateGenerator/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/randomStateGenerator/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
