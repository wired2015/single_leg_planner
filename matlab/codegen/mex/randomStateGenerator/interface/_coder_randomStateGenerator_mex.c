...
emlrtContext emlrtContextGlobal = { true, false, EMLRT_VERSION_INFO, NULL, "randomStateGenerator", NULL, false, {2045744189U,2170104910U,2743257031U,4284093946U}, NULL };
...
static void randomStateGenerator_mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  randomStateGenerator_initialize(&emlrtContextGlobal);
  ...
  /* Module finalization. */
  randomStateGenerator_terminate();
}

void randomStateGenerator_atexit_wrapper(void)
{
   randomStateGenerator_atexit();
}

void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  /* Initialize the memory manager. */
  mexAtExit(randomStateGenerator_atexit_wrapper);
  /* Dispatch the entry-point. */
  randomStateGenerator_mexFunction(nlhs, plhs, nrhs, prhs);
}
/* End of code generation (_coder_randomStateGenerator_mex.c) */
