...
static emlrtRSInfo mb_emlrtRSI = { 6, "getPhiAndOmega",
  "/Users/fuji/Dropbox/phd/matlab/singleLegPlanning/single_leg_planner/matlab/kinematics/getPhiAndOmega.m"
};

static emlrtBCInfo q_emlrtBCI = { 1, 4, 42, 17, "kC.legAngleOffset",
  "generateTrMatrices",
                    ...
                    legNum, real_T *phi, real_T *omega)
{
  ...
  static const int8_T iv8[4] = { 0, 0, 1, 0 };

  static const real_T dv2[4] = { 0.0, -1.0, 6.123233995736766E-17, 0.0 };

  static const int8_T iv9[4] = { 1, 0, 0, 0 };

  real_T TS2R[16];
  static const int8_T iv10[4] = { 0, 1, 0, 0 };
  ...
  emlrtDynamicBoundsCheckFastR2012b(legNum, 1, 4, &q_emlrtBCI, &st);
