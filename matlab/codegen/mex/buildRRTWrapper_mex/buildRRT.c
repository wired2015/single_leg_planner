...
static emlrtRSInfo sb_emlrtRSI = { 21, "colon",
  "/Applications/MATLAB_R2014b.app/toolbox/eml/lib/matlab/ops/colon.m" };

static emlrtRSInfo tb_emlrtRSI = { 79, "colon",
  "/Applications/MATLAB_R2014b.app/toolbox/eml/lib/matlab/ops/colon.m" };
...
static emlrtBCInfo q_emlrtBCI = { -1, -1, 82, 7, "T", "buildRRT",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/normalRRT/buildRRT.m",
  0 };

static emlrtECInfo d_emlrtECI = { -1, 82, 5, "buildRRT",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/normalRRT/buildRRT.m"
};
...
static emlrtBCInfo r_emlrtBCI = { -1, -1, 55, 47, "transitionArray", "buildRRT",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/normalRRT/buildRRT.m",
  0 };
              ...
              *path)
{
  ...
  ndbl = 2000 * (int32_T)emlrtNonNegativeCheckFastR2012b(i4, &b_emlrtDCI, sp);
  for (i4 = 0; i4 < ndbl; i4++) {
    T->data[i4] = 0.0;
  }
  ...
  for (apnd = 0; apnd < 1999; apnd++) {
    ...
    emlrtDynamicBoundsCheckFastR2012b(i4, 1, 2000, &q_emlrtBCI, &st);
    ndbl = T->size[1];
    i4 = r0->size[0];
    r0->size[0] = ndbl;
    emxEnsureCapacity(&st, (emxArray__common *)r0, i4, (int32_T)sizeof(int32_T),
                      &c_emlrtRTEI);
    for (i4 = 0; i4 < ndbl; i4++) {
      r0->data[i4] = i4;
    }
    ...
    emxEnsureCapacity(&st, (emxArray__common *)next, i4, (int32_T)sizeof(real_T),
                      &c_emlrtRTEI);
    for (i4 = 0; i4 < 13; i4++) {
      next->data[next->size[0] * i4] = xNew_data[xNew_size[0] * i4];
    }

    ndbl = transitionArray->size[1];
    for (i4 = 0; i4 < ndbl; i4++) {
      next->data[next->size[0] * (i4 + 13)] = transitionArray->
        data[transitionArray->size[0] * i4];
    }
    ...
    ndbl = next->size[1];
    for (i4 = 0; i4 < ndbl; i4++) {
      T->data[((int32_T)(nodeIDCount + 1.0) + T->size[0] * r0->data[i4]) - 1] =
        next->data[next->size[0] * i4];
    }
  ...
  while ((!exitg1) && (transitionArrayLength != 0.0)) {
    ...
    if (next->data[1] != 0.0) {
      ...
      while (apnd <= i4 - 1) {
        ...
        for (cdiff = 0; cdiff < 10; cdiff++) {
          ...
          c_transitionPath->data[transitionPath->size[0] +
            ...
            data[emlrtDynamicBoundsCheckFastR2012b(ndbl, 1, absb, &r_emlrtBCI,
            sp) - 1];
        }
      ...
      i4 = (int32_T)emlrtIntegerCheckFastR2012b(transitionArrayLength, &emlrtDCI,
        sp);
      emlrtDynamicBoundsCheckFastR2012b(i4, 1, 2000, &n_emlrtBCI, sp);
      i4 = next->size[0] * next->size[1];
      next->size[0] = 1;
      next->size[1] = ndbl;
      emxEnsureCapacity(sp, (emxArray__common *)next, i4, (int32_T)sizeof(real_T),
      ...
      if (14 > next->size[1]) {
        ...
        cdiff = next->size[1];
        absb = next->size[1];
        cdiff = emlrtDynamicBoundsCheckFastR2012b(absb, 1, cdiff, &l_emlrtBCI,
          sp);
      }
