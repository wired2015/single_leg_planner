...
#include "buildRRTWrapper_mex_terminate.h"
...
emlrtContext emlrtContextGlobal = { true, false, EMLRT_VERSION_INFO, NULL, "buildRRTWrapper_mex", NULL, false, {2045744189U,2170104910U,2743257031U,4284093946U}, NULL };
...
void buildRRTWrapper_mex_atexit_wrapper(void)
{
   buildRRTWrapper_mex_atexit();
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  mexAtExit(buildRRTWrapper_mex_atexit_wrapper);
  /* Dispatch the entry-point. */
  method(nlhs, plhs, nrhs-1, prhs+1);
}
/* End of code generation (_coder_buildRRTWrapper_mex_mex.c) */
