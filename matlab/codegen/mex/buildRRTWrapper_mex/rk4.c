...
static emlrtRSInfo ob_emlrtRSI = { 112, "rk4",
         ...
         int32_T legNum, real_T xNewFull[13], real_T transitionArray[80])
{
  ...
  for (i = 0; i < 7; i++) {
    ...
    for (i9 = 0; i9 < 10; i9++) {
      c_xInit[i9] = b_xInit[i9] + 0.05 * k1[i9];
    }

    f(c_xInit, u, kC->l3, kC->l5, kC->zeta, k2);
    for (i9 = 0; i9 < 10; i9++) {
      c_xInit[i9] = b_xInit[i9] + 0.05 * k2[i9];
    }

    f(c_xInit, u, kC->l3, kC->l5, kC->zeta, k3);
    for (i9 = 0; i9 < 10; i9++) {
      c_xInit[i9] = b_xInit[i9] + 0.05 * k3[i9];
    }

    f(c_xInit, u, kC->l3, kC->l5, kC->zeta, dv17);
    for (i9 = 0; i9 < 10; i9++) {
      k1[i9] = b_xInit[i9] + 0.016666666666666666 * (((k1[i9] + 2.0 * k2[i9]) +
        2.0 * k3[i9]) + dv17[i9]);
    }
    ...
    i11 = i10 - i9;
    emlrtSizeEqCheck1DFastR2012b(i11, 10, &e_emlrtECI, sp);
    loop_ub = i10 - i9;
    for (i11 = 0; i11 < loop_ub; i11++) {
      tmp_data[i11] = (uint8_T)(i9 + i11);
    }

    loop_ub = i10 - i9;
    for (i9 = 0; i9 < loop_ub; i9++) {
      transitionArray[tmp_data[i9]] = k1[i9];
    }
