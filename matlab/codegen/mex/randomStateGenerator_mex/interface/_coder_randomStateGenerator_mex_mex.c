/*
 * _coder_randomStateGenerator_mex_mex.c
 *
...
/* Include files */
#include "mex.h"
#include "_coder_randomStateGenerator_mex_api.h"
#include "randomStateGenerator_mex_initialize.h"
#include "randomStateGenerator_mex_terminate.h"
...
emlrtContext emlrtContextGlobal = { true, false, EMLRT_VERSION_INFO, NULL, "randomStateGenerator_mex", NULL, false, {2045744189U,2170104910U,2743257031U,4284093946U}, NULL };
...
static void buildRRTWrapper_mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  randomStateGenerator_mex_initialize(&emlrtContextGlobal);
  st.tls = emlrtRootTLSGlobal;
  /* Check for proper number of arguments. */
  if (nrhs != 15) {
    emlrtErrMsgIdAndTxt(&st, "EMLRT:runTime:WrongNumberOfInputs", 5, mxINT32_CLASS, 15, mxCHAR_CLASS, 15, "buildRRTWrapper");
  } else if (nlhs > 4) {
  ...
  /* Module finalization. */
  randomStateGenerator_mex_terminate();
}
static void randomStateGenerator_mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
...
void randomStateGenerator_mex_atexit_wrapper(void)
{
   randomStateGenerator_mex_atexit();
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  mexAtExit(randomStateGenerator_mex_atexit_wrapper);
  /* Dispatch the entry-point. */
  method(nlhs, plhs, nrhs-1, prhs+1);
}
/* End of code generation (_coder_randomStateGenerator_mex_mex.c) */
