...
static emlrtRSInfo qb_emlrtRSI = { 26, "selectInput",
...
static emlrtECInfo c_emlrtECI = { -1, 30, 26, "selectInput",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/selectInput.m"
};
                 ...
                 *transitionArray)
{
  ...
  for (i = 0; i < 5; i++) {
    ...
    emlrtSubAssignSizeCheckR2012b(iv8, 2, tmp_size, 2, &d_emlrtECI, sp);
    ixstart = tmp_size[1];
    for (i6 = 0; i6 < ixstart; i6++) {
