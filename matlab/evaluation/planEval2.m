%PLANEVAL Evaluates the Bi-Direcitonal RRT-based single leg planner.
%
...
%     fprintf('Ankle Heuristic Gain: %.2f\n\n',gains(3));
    ...
    %generated plans.
    plannerResults = struct('T1',{},'T2',{},'pathC',{},'pathJ',{},'success',{},'pathLength',{},'pathTime',{});
    ...
    for i=1:numLegs
        ...
        %structures.
        plannerResults(i).T1 = T1;
        plannerResults(i).T2 = T2;
        ...
        if success
            ...
            printBiDirRRT(T1,T2,pathJ,kC,jointLimits);
