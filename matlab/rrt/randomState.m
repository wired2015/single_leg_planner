...
function xRand = randomState(range,MIN,kC,panHeight,xGoal,nodeIDCount,goalSeedFreq)
...
%       xRand:  The 1xn vector describing the selected random state.
    ...
    [betaRand,gammaRand1] = getConstrainedBeta(panHeight,gammaRand,kC,range,MIN(2));
    ...
    xRand = [zeros(1,3) alphaRand gammaRand1 betaRand 0 0 0];
