...
static emlrtRSInfo vb_emlrtRSI = { 91, "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m"
};

static emlrtRSInfo wb_emlrtRSI = { 6, "getPhiAndOmega",
...
static emlrtBCInfo gb_emlrtBCI = { -1, -1, 118, 9, "transitionArray", "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m",
  0 };

static emlrtECInfo e_emlrtECI = { -1, 118, 9, "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m"
};
...
static emlrtDCInfo i_emlrtDCI = { 15, 31, "rk4",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/rrt/rk4.m",
  4 };
         ...
         xNew_size[2], emxArray_real_T *transitionArray)
{
  ...
  absxk = emlrtNonNegativeCheckFastR2012b(absxk, &i_emlrtDCI, sp);
  ...
  absxk = (numIterations + 1.0) * 10.0;
  absxk = emlrtNonNegativeCheckFastR2012b(absxk, &i_emlrtDCI, sp);
  loop_ub = (int32_T)emlrtIntegerCheckFastR2012b(absxk, &h_emlrtDCI, sp);
  ...
  for (i7 = 0; i7 < 10; i7++) {
    transitionArray->data[emlrtDynamicBoundsCheckFastR2012b(i7 + 1, 1,
      unnamed_idx_1, &hb_emlrtBCI, sp) - 1] = xInit_data[i7];
  }
  ...
  while (i <= (int32_T)numIterations - 1) {
    ...
    k1[5] = u[0];
    k1[6] = u[1];
    k1[7] = ((-u[1] * kC->l3 * muDoubleScalarCos(xInit_data[1]) + xInit_data[6] *
              xInit_data[6] * kC->l3 * muDoubleScalarSin(xInit_data[1])) +
             xInit_data[7] * xInit_data[7] * kC->l5 * muDoubleScalarSin(kC->zeta
              + d_xInit_data[2])) / (kC->l5 * muDoubleScalarCos(kC->zeta +
      e_xInit_data[2]));
    k1[8] = 0.0;
    k1[9] = 0.0;
    y = dt / 2.0;
    ...
    if ((betaDot > jointLimits[13]) || (betaDot < jointLimits[12]) || (gammaDot >
         jointLimits[15]) || (gammaDot < jointLimits[14])) {
    ...
    if (absxk > scale) {
      ...
      i8 = (int32_T)absxk;
      i7 = emlrtDynamicBoundsCheckFastR2012b(i8, 1, i7, &gb_emlrtBCI, sp);
      i8 = transitionArray->size[1];
      unnamed_idx_1 = (int32_T)scale;
      i8 = emlrtDynamicBoundsCheckFastR2012b(unnamed_idx_1, 1, i8, &gb_emlrtBCI,
        sp) + 1;
    }

    i8 -= i7;
    emlrtSizeEqCheck1DFastR2012b(i8, 10, &e_emlrtECI, sp);
    loop_ub = xNew_size[1];
