...
extern void selectInput(const emlrtStack *sp, const real_T xNear_data[], const
  real_T xRand[13], const real_T U[10], real_T dt, real_T Dt, const real_T
  HGAINS[3], const struct0_T *kC, real_T ankleThreshold, const real_T
  jointLimits[20], const real_T uBDot[6], int32_T legNum, real_T xNew_data[],
