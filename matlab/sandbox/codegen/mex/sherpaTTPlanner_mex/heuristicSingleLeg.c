...
real_T b_heuristicSingleLeg(const real_T xA[13], const real_T xB[13], real_T
...
real_T c_heuristicSingleLeg(const real_T xA_data[], const real_T xB[93], real_T
  kC_l1, real_T kC_l2, real_T kC_l3, real_T kC_l4, real_T kC_l5, real_T kC_l6,
  real_T kC_l7, real_T kC_l8, real_T kC_zeta, real_T kC_r)
{
  real_T d;
  ...
  for (i14 = 0; i14 < 3; i14++) {
    b_uB[i14] = uB[i14] - uA[i14];
    c_qDot[i14] = qDot[i14] - b_qDot[i14];
  }
...
real_T heuristicSingleLeg(const real_T xA[13], const real_T xB[93], real_T kC_l1,
