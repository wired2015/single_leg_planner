...
static emlrtRTEInfo n_emlrtRTEI = { 1, 1, "_coder_buildRRTWrapper_api", "" };
  ...
  void buildRRTWrapper_api(const mxArray * const prhs[12], const mxArray *plhs[4])
{
  ...
  emxInit_real_T(&st, &T, 2, &n_emlrtRTEI, true);
  emxInit_real_T(&st, &pathC, 2, &n_emlrtRTEI, true);
  emxInit_real_T(&st, &pathJ, 2, &n_emlrtRTEI, true);
