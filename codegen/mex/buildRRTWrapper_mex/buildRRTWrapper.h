...
extern void buildRRTWrapper(const emlrtStack *sp, const real_T nInitCartesianB[6],
  ...
  real_T jointLimits[20], real_T bodyHeight, const real_T U[18], real_T dt,
  real_T Dt, const struct0_T *kC, int32_T legNum, const real_T uBDot[6],
...
extern void threshold_not_empty_init(void);
