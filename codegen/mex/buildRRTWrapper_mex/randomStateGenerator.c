...
static emlrtRSInfo tb_emlrtRSI = { 19, "randomStateGenerator",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/evaluation/randomStateGenerator.m"
};

static emlrtRSInfo ub_emlrtRSI = { 20, "randomStateGenerator",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/evaluation/randomStateGenerator.m"
};

static emlrtRSInfo vb_emlrtRSI = { 3, "randomPoint",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/evaluation/randomPoint.m"
};

static emlrtRSInfo wb_emlrtRSI = { 8, "randomPoint",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/evaluation/randomPoint.m"
};

static emlrtRTEInfo n_emlrtRTEI = { 1, 19, "randomStateGenerator",
  "/Users/fuji/Dropbox/PhD/matlab/singleLegPlanning/single_leg_planner/matlab/evaluation/randomStateGenerator.m"
};

static emlrtBCInfo ib_emlrtBCI = { -1, -1, 20, 16, "states",
  ...
  emxArray_real_T *states)
{
  ...
  c_st.prev = &b_st;
  c_st.tls = b_st.tls;
  i8 = states->size[0] * states->size[1];
  states->size[0] = (int32_T)emlrtNonNegativeCheckFastR2012b(NUM_POINTS,
    &i_emlrtDCI, sp);
  states->size[1] = 6;
  emxEnsureCapacity(sp, (emxArray__common *)states, i8, (int32_T)sizeof(real_T),
                    &n_emlrtRTEI);
  ...
  while (b_i <= NUM_POINTS) {
    ...
    i = states->size[0];
    emlrtDynamicBoundsCheckFastR2012b(b_i, 1, i, &ib_emlrtBCI, sp);
    for (i8 = 0; i8 < 3; i8++) {
      xMax = 0.0;
      for (i = 0; i < 3; i++) {
        xMax += TP2B[i8 + (i << 2)] * uP[i];
      }

      u1[i8] = xMax + TP2B[12 + i8];
    }

    for (i8 = 0; i8 < 3; i8++) {
      states->data[(b_i + states->size[0] * i8) - 1] = u1[i8];
    }
